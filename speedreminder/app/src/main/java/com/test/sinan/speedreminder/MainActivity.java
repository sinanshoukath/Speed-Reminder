...
import static com.test.sinan.speedreminder.LocationService.PREF_IS_RUNNING;
...
public class MainActivity extends Activity {
    ...
    static TextView dist, time, speed, speed2;
    ...
    public static final int MY_PERMISSIONS_REQUEST_LOC = 145;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.speedometer_2);


        dist = (TextView) findViewById(R.id.distancetext);
        time = (TextView) findViewById(R.id.timetext);
        speed = (TextView) findViewById(R.id.speedtext);
        speed2 = (TextView)findViewById(R.id.speedtext2);
